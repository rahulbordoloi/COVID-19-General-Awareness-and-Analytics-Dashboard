...
@cross_origin()
def webhook():                                                 # process all the requests given by dialogflow. 
...
def processRequest(req):
    ...
    if intent == 'cases.cases-custom-2':
       ...
       #fulfillmentText = makeAPIRequest("state")
        ...
        return {
            "fulfillmentText": "Sorry, Servers aren't Responding. Please Try Again. Start from the Beginning? ",
        }
